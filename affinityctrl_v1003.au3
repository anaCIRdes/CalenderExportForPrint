...
$filename = "2023_00.jpg"
$path_to_photo1 = "C:\Test\2023_00.jpg"		; TODO: um hier mehr zu automatisieren muessten alle vorhandenen Files ausgelesen werden, gemerkt werden und alle nacheinander abgearbeitet werden
$path_to_photo1_new = "C:\Test\2023_00_3mm-sRGB.jpg"
$iCountOfFiles = 0
...
For $i2 = 1 to $iCountOfFiles Step 1				; Dateien fangen bei 1 an
	...
	ShellExecute("C:\Program Files\Affinity\Photo\Photo.exe", FileGetShortName("D:\Daten\Programmierung\Programmieren + Tutorials\AutoIT\Scripte\myScripts\AffinityCTRL_V1\A4_mit_3mm_Rand_Vorlage.psd"))
	...
	MouseClickDrag($MOUSE_CLICK_LEFT, 267, 941, 245, 957)
